...
#define HOMING_CYCLE_0 		    (1<<B_AXIS)                // REQUIRED: First move B to clear workspace.
#define HOMING_CYCLE_1 		    (1<<A_AXIS)                // REQUIRED: First move A to clear workspace.
#define HOMING_CYCLE_2 		    (1<<Z_AXIS)                // REQUIRED: First move Z to clear workspace.
#define HOMING_CYCLE_3 		    ((1<<X_AXIS)|(1<<Y_AXIS))  // OPTIONAL: Then move X,Y at the same time.
